    ...
    <footer className="relative z-10 bg-[#09090b] border-t border-zinc-800 pt-16 pb-8 px-6 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          {/* Brand */}
          <div>
            <p className="font-mono font-bold text-white text-sm tracking-wider mb-3">Jagadish · Motion Magicx</p>
            <p className="text-zinc-500 font-light text-sm mb-6">Stories shot and shaped.</p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="mailto:motion.magicx@gmail.com" className="block font-mono text-sm text-zinc-500 hover:text-white transition-colors">
                 motion.magicx@gmail.com
              </a>
               <p className="font-mono text-sm text-zinc-600">+91 90144 21727</p>
              <p className="font-mono text-sm text-zinc-600">Hyderabad · Available for Travel</p>
              <div className="pt-2">
        ...
        <div className="border-t border-zinc-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-mono text-xs text-zinc-600">
            © 2025 Jagadish · Motion Magicx. All rights reserved.
          </p>
