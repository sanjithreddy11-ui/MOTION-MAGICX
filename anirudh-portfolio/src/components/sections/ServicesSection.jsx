...
const services = [
  {
    ...
    description: 'Instagram and YouTube Shorts shot on iPhone, edited to stop the scroll. Fast-paced, rhythm-driven, platform-optimized.',
    tags: ['Instagram', 'Reels', 'Shorts'],
    Icon: IconCamera,
  },
  {
    num: '02',
    title: 'Event Videography',
    description: 'On-location coverage for events across Hyderabad — captured on iPhone and shaped into a polished, cinematic recap.',
    tags: ['Events', 'Coverage', 'Hyderabad'],
    Icon: IconClapper,
  },
  {
    num: '03',
    title: 'Wedding Content',
    description: 'Cinematic wedding films and reels that hold on to the emotion of the day, shot and edited with care.',
    tags: ['Weddings', 'Cinematic', 'Reels'],
    Icon: IconMusic,
  },
  {
    num: '04',
    title: 'Brand Content',
    description: 'Product and lifestyle content for brands, built to feel premium and drive real engagement.',
    tags: ['Brands', 'Lifestyle', 'Content'],
    Icon: IconSun,
  },
  {
    num: '05',
    title: 'Promotional Videos',
    description: 'Launch videos, ads, and campaign content designed to grab attention and communicate the message fast.',
    tags: ['Ads', 'Launches', 'Campaigns'],
    Icon: IconGrid,
  },
  {
    num: '06',
    title: 'Video Editing',
    description: 'Professional post-production — pacing, color, and polish — that turns raw footage into a finished story.',
    tags: ['Premiere Pro', 'DaVinci Resolve', 'Post-Production'],
    Icon: IconWave,
  },
];
