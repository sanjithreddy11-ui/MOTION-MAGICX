...
const tickerItems = [
  "IPHONE VIDEOGRAPHY", "CINEMATOGRAPHY", "COLOR GRADING", "REELS",
  "SHORTS", "EVENT FILMS", "WEDDING FILMS", "BRAND CONTENT", "STORYTELLING"
];
      ...
      <div className="relative z-10 flex flex-row items-center justify-between w-full max-w-6xl">
        ...
        <div className="max-w-2xl">
          ...
          <motion.p
            ...
            I shoot on iPhone and edit with intent — turning everyday moments
            into cinematic stories. Every frame is composed. Every cut has a purpose.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
