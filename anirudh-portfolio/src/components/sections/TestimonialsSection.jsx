...
const testimonials = [
  {
    quote: 'Working with Jagadish completely transformed our brand content. The edits weren\'t just clean — they were cinematic. Our engagement grew noticeably within the first month.',
    name: 'Ananya Mehta',
    role: 'Business Owner, Hyderabad',
  },
  {
    quote: 'He doesn\'t just shoot videos, he tells stories. Every frame has a purpose, every transition hits at exactly the right moment. Best I\'ve worked with in Hyderabad.',
    name: 'Marcus Chen',
    role: 'Brand Founder, Hyderabad',
  },
  {
    quote: 'The quality is festival-grade every single time, and he\'s easy to work with from brief to final cut. Our reels have never looked this good.',
    name: 'Priya Sharma',
    role: 'Content Lead, Hyderabad',
  },
  {
    quote: 'Jagadish has an intuition for pacing that most creators take years to develop. He understood our vision from day one and delivered beyond expectations.',
    name: 'David Park',
    role: 'Event Client, Hyderabad',
  },
];
